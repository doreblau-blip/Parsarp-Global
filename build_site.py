...
.lang-btn:hover:not(.active) { color: var(--c-slate); }

.lang-btn.active {
  background: var(--c-slate);
  color: var(--c-white);
  box-shadow: 0 1px 4px rgba(25, 58, 78, 0.15);
}
...
/* ── Hero Image Container (Right Side Image) ── */
.hero-visual {
  position: relative;
  display: flex;
  justify-content: center;
...
<body>
  ...
  <!-- ═══ HERO (Text Slider Left, Image Right) ═══ -->
  <section class="hero" id="hero">
    <div class="container">
      ...
      <div class="hero-slider-wrap">
        <div class="hero-slider">
          ...
          <div class="hero-slide active" data-slide="0">
            <div class="hero-badge reveal">
              <span class="dot"></span>
              <span class="label" style="margin:0; font-size: 0.65rem;" data-i18n="hero.slide1.badge">İstanbul → Dubai</span>
            </div>
            <h1 class="reveal reveal-delay-1" data-i18n="hero.slide1.headline">Güzelliğin <span class="accent">Güvenilir Adresi.</span></h1>
            <p class="reveal reveal-delay-2" data-i18n="hero.slide1.text">
              www.parsarpglobal.com olarak, Dubai merkezli temizlik ürünleri satışında temizlik ve bakım odaklı, seçkin markaları bir araya getiriyoruz. Cilt, saç ve vücut bakımında yüksek kalite standartlarına uygun, güvenilir ve etkili ürünler sunmaya önem veriyoruz.
            </p>
            <div class="hero-actions reveal reveal-delay-3">
              <a href="#contact" class="btn btn-primary" data-i18n="hero.slide1.ctaPrimary">Teklif Alın →</a>
              <a href="#products" class="btn btn-secondary" data-i18n="hero.slide1.ctaSecondary">Ürünleri İnceleyin</a>
            </div>
          </div>
          ...
          <div class="hero-slide" data-slide="1">
            <div class="hero-badge">
              <span class="dot"></span>
              <span class="label" style="margin:0; font-size: 0.65rem;" data-i18n="hero.slide2.badge">Premium Güzellik ve Bakım</span>
            </div>
            <h1 data-i18n="hero.slide2.headline">Seçkin Markalar, <span class="accent">Özenli Rutinler.</span></h1>
            <p data-i18n="hero.slide2.text">
              www.parsarpglobal.com olarak Dubai’de temizlik ve bakım konusunda uzmanlığımızla seçilmiş güzellik ürünleri sunuyoruz. Cilt, saç ve kişisel bakım rutininizi destekleyen kaliteli ve güvenilir markaları tek bir çatı altında topluyoruz. İhtiyaçlarınıza uygun ürünleri kolayca bulabilmeniz için özenle hazırlanmış bir alışveriş deneyimi sağlıyoruz.
            </p>
            <div class="hero-actions">
              <a href="#products" class="btn btn-primary" data-i18n="hero.slide2.ctaPrimary">Kataloğu Gör →</a>
              <a href="#contact" class="btn btn-secondary" data-i18n="hero.slide2.ctaSecondary">Bize Ulaşın</a>
            </div>
          </div>
        ...
        <div class="slider-controls reveal reveal-delay-4">
      ...
      <div class="hero-visual reveal reveal-delay-4">
        <div class="hero-image-container">
          <img src="hero_products.jpg" alt="Parsarp Global Premium Ürünler">
        </div>
      </div>
  ...
  <script>
      ...
      tr: {{
        ...
        hero: {{
          slide1: {{
            ...
            text: "www.parsarpglobal.com olarak, Dubai merkezli temizlik ürünleri satışında temizlik ve bakım odaklı, seçkin markaları bir araya getiriyoruz. Cilt, saç ve vücut bakımında yüksek kalite standartlarına uygun, güvenilir ve etkili ürünler sunmaya önem veriyoruz.",
            ctaPrimary: "Teklif Alın →",
            ctaSecondary: "Ürünleri İnceleyin"
          }},
          slide2: {{
            badge: "Premium Güzellik ve Bakım",
            headline: 'Seçkin Markalar, <span class="accent">Özenli Rutinler.</span>',
            text: "www.parsarpglobal.com olarak Dubai’de temizlik ve bakım konusunda uzmanlığımızla seçilmiş güzellik ürünleri sunuyoruz. Cilt, saç ve kişisel bakım rutininizi destekleyen kaliteli ve güvenilir markaları tek bir çatı altında topluyoruz. İhtiyaçlarınıza uygun ürünleri kolayca bulabilmeniz için özenle hazırlanmış bir alışveriş deneyimi sağlıyoruz.",
            ctaPrimary: "Kataloğu Gör →",
      ...
      en: {{
        ...
        hero: {{
          ...
          slide2: {{
            ...
            headline: 'Curated Brands, <span class="accent">Mindful Routines.</span>',
            text: "In Dubai, we offer curated beauty products backed by our expertise in hygiene and care. We gather high-quality, reliable brands under one roof to support your skin, hair, and personal care routine.",
    ...
    function setLanguage(lang) {{
      try {{
        ...
        localStorage.setItem('parsarp_lang', lang);
      }} catch(e) {{
        console.warn('Language set notice:', e);
      }}
    }}
    ...
    try {{
      const savedLang = localStorage.getItem('parsarp_lang');
...
print("Build complete with Hero Slider + Right Hero Image.")
